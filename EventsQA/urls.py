...
schema_view = get_schema_view(
    openapi.Info(
        title="EventsQA API",
        default_version='v1',
        description="Welcome to the world of Eventsqa",
        terms_of_service="https://www.Eventsqa.org",
        contact=openapi.Contact(email="ifeolulesi@gmail.com"),
...
urlpatterns = [
  ...
  path('api/v1/', include('mainQA.urls')),
